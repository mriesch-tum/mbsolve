...
#ifndef MBSOLVE_SOLVER_OPENMP_FDTD_RED_H
#define MBSOLVE_SOLVER_OPENMP_FDTD_RED_H
...
class solver_openmp_fdtd_red : public solver_int
{
public:
    solver_openmp_fdtd_red(std::shared_ptr<const device> dev,
                           std::shared_ptr<scenario> scen);

    ~solver_openmp_fdtd_red();
