...
#@ output = riesch2017b-pc-256k-$(schedd_host).$(jobid).$(stepid).out
#@ error = riesch2017b-pc-256k-$(schedd_host).$(jobid).$(stepid).out
#@ notification=always
#@ queue
...
gridpoints=262144
endtime=200e-15
name=riesch2017b-pc-256k
method=openmp-2lvl-pc-red
