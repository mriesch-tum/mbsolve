...
#@ output = riesch2017b-os-128k-$(schedd_host).$(jobid).$(stepid).out
#@ error = riesch2017b-os-128k-$(schedd_host).$(jobid).$(stepid).out
#@ notification=always
#@ queue
...
gridpoints=131072
endtime=200e-15
name=riesch2017b-os-128k
method=openmp-2lvl-os-old
